...
python ${PROJECT_ROOT}/main_ft.py \
    ...
    --output ${PROJECT_ROOT}/outputs_new/finetune/bp_adapter_ft \
    --root_log_dir ${PROJECT_ROOT}/logs_new/finetune/bp_adapter_ft \
    --algorithm bp_adapter_ft \
    --lr ${lr} \
